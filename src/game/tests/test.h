...
namespace SITest {
	...
	public:
		MockShip(SI::VShipDriver*, SI::Vector2, int, SI::ShipType, SI::IGameEntityFactory*);
	...
	public:
		MockBullet(SI::Vector2, int, SI::BulletType, SI::IGameEntityFactory*);
	...
	public:
		SI::Ship* createShip(SI::VShipDriver*, SI::Vector2, int, SI::ShipType);	
		SI::Bullet* createBullet(SI::Vector2, int, SI::BulletType);
